...
class ListTableDefinition:
    ...
    @staticmethod
    def builder() -> ListTableDefinition:
        """
        ...
        Returns:
            a ListTableDefinition formally describing a table with no columns.
        """
    ...
    def add_scalar_column(
        ...
        Returns:
            a ListTableDefinition obtained by adding (or replacing) the desired
    ...
    def add_partition_by(
        ...
        Returns:
            a ListTableDefinition obtained by enriching the `partition_by`
    ...
    def add_partition_sort(self, partition_sort: dict[str, int]) -> ListTableDefinition:
        """
        ...
        Returns:
            a ListTableDefinition obtained by enriching the `partition_sort`
            of this table definition as requested.
        """
    ...
    def build(self) -> ListTableDefinition:
        """
        ...
        Returns:
            a ListTableDefinition obtained by finalizing the definition being
                built so far.
        """
