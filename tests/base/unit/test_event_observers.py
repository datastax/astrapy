...
OBS_LOG_1 = ObservableLog(level=logging.DEBUG, message="The log 1")
OBS_LOG_2 = ObservableLog(level=logging.ERROR, message="The log 2")
...
OBS_RSP = ObservableResponse(body={"k": "v"})
...
class TestEventObservers:
    ...
    def test_custom_observer(self) -> None:
        ...
        my_obs.receive(OBS_LOG_1)
        my_obs.receive(OBS_ERR)
        my_obs.receive(OBS_WRN)
        my_obs.receive(OBS_LOG_1)
        my_obs.receive(OBS_RSP)
        ...
        assert received_events[ObservableEventType.RESPONSE] == [OBS_RSP]
    ...
    def test_observer_from_evdict(self) -> None:
        ...
        my_obs_f.receive(OBS_LOG_1)
        my_obs_f.receive(OBS_ERR)
        my_obs_f.receive(OBS_WRN)
        my_obs_f.receive(OBS_LOG_1)
        my_obs_f.receive(OBS_RSP)
